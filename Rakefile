...
desc 'Generate documentation for the order_note extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'OrderNoteExtension'
...
desc 'Test the order_note extension.'
...
namespace :test do
  desc 'Functional test the order_note extension.'
  ...
  desc 'Unit test the order_note extension.'
